import{_ as s,o as n,c as a,b as l}from"./app.f4aabbaf.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"下载视频音频的开源库","slug":"下载视频音频的开源库","link":"#下载视频音频的开源库","children":[]},{"level":2,"title":"pdf文档解析","slug":"pdf文档解析","link":"#pdf文档解析","children":[]},{"level":2,"title":"PDF文档解析","slug":"pdf文档解析-1","link":"#pdf文档解析-1","children":[]}],"relativePath":"javascript/2023-03-30-yt-dlp.md","lastUpdated":1683547689000}'),p={name:"javascript/2023-03-30-yt-dlp.md"},e=l(`<h2 id="下载视频音频的开源库" tabindex="-1">下载视频音频的开源库 <a class="header-anchor" href="#下载视频音频的开源库" aria-hidden="true">#</a></h2><ul><li>开源地址 <a href="https://github.com/yt-dlp/yt-dlp" target="_blank" rel="noreferrer">https://github.com/yt-dlp/yt-dlp</a> 根据开源地址中安装对应的版本，window下的话可以设置环境变量，这样全局都可以使用该命令</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 下载视频文件</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,9),o=[e];function c(t,C,A,i,r,y){return n(),a("div",null,o)}const d=s(p,[["render",c]]);export{h as __pageData,d as default};

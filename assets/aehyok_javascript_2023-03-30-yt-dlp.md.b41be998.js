import{_ as s,o as n,c as a,O as l}from"./chunks/framework.fb7bb97b.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"aehyok/javascript/2023-03-30-yt-dlp.md","filePath":"aehyok/javascript/2023-03-30-yt-dlp.md","lastUpdated":1685585649000}'),p={name:"aehyok/javascript/2023-03-30-yt-dlp.md"},e=l(`<h2 id="下载视频音频的开源库" tabindex="-1">下载视频音频的开源库 <a class="header-anchor" href="#下载视频音频的开源库" aria-label="Permalink to &quot;下载视频音频的开源库&quot;">​</a></h2><ul><li>开源地址 <a href="https://github.com/yt-dlp/yt-dlp" target="_blank" rel="noreferrer">https://github.com/yt-dlp/yt-dlp</a> 根据开源地址中安装对应的版本，window下的话可以设置环境变量，这样全局都可以使用该命令</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 下载视频文件</span></span>

import{_ as s,o as n,c as a,O as l}from"./chunks/framework.fb7bb97b.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"aehyok/javascript/2022-08-22-nginx 负载均衡.md","filePath":"aehyok/javascript/2022-08-22-nginx 负载均衡.md","lastUpdated":1684202565000}'),p={name:"aehyok/javascript/2022-08-22-nginx 负载均衡.md"},e=l(`<ul><li>先上一个前端版本，同一份打包编译后的文件，分别部署到one和two.</li><li>因为我只有一台服务器，所以这里通过端口进行演示： one对应端口91，two对应端口92.</li><li>通过upstream nginxlbdemo进行负载配置.</li><li>最后通过proxy_pass反向代理 upstream.</li><li>如果有修改nginx的配置文件，修改完毕后记得 <code>nginx -s reload</code></li></ul><p>nginx-lb.conf</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">upstream nginxlbdemo{</span></span>
